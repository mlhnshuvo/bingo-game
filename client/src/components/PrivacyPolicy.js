...
const PrivacyPolicy = () => {
  return (
    <div className="w-2/3 m-auto my-20 p-10 bg-yellow-400">
      <p className="text-3xl my-10">Privacy Policy for Bingolar</p>
      <p>
        Consent By using our website, you hereby consent to our Privacy Policy
        and agree to its terms. Information we collect The personal information
        ...
        your personal information. If you contact us directly, we may receive
        additional information about you such as your name, email address, phone
        number, the contents of the message and/or attachments you may send us,
        and any other information you may choose to provide. When you register
        for an Account, we may ask for your contact information, including items
        such as name, company name, address, email address, and telephone
        number. How we use your information We use the information we collect in
        various ways, including to: Provide, operate, and maintain our website
        Improve, personalize, and expand our website Understand and analyze how
        you use our website Develop new products, services, features, and
        ...
        Files Bingolar follows a standard procedure of using log files. These
        ...
        information. Cookies and Web Beacons Like any other website, Bingolar
        ...
        cookies, please read "What Are Cookies" from Cookie Consent. Advertising
        Partners Privacy Policies You may consult this list to find the Privacy
        Policy for each of the advertising partners of Bingolar. Third-party ad
        ...
        that appear on Bingolar, which are sent directly to users' browser. They
        ...
        websites that you visit. Note that Bingolar has no access to or control
        over these cookies that are used by third-party advertisers. Third Party
        Privacy Policies Bingolar's Privacy Policy does not apply to other
        ...
        collects a consumer's personal data disclose the categories and specific
        ...
        consumer's personal data, not sell the consumer's personal data. If you
        make a request, we have one month to respond to you. If you would like
        to exercise any of these rights, please contact us. GDPR Data Protection
